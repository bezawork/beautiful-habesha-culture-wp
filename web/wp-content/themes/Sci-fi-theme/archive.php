...
<section class="breadcrumbs-modern box-transform-wrap bg-image context-dark"
  ...
  <div class="container">
    <div class="breadcrumbs-modern-body">
      ...
      <h1 class="breadcrumbs-modern-title"> <?php echo get_the_archive_title()?></h1>
    </div>
  </div>
...
<section class="section section-xl bg-default text-md-left">
  <div class="container">
   ...
   while(have_posts()){
    the_post(); ?>
        <article class="post post-creative"><a class="post-creative-figure" href="single-post.html"><img
              src="<?php echo get_theme_file_uri('/site/images/post-7-770x524.jpg')?>" alt="" width="770"
              height="524" /></a>
          <div class="unit flex-column flex-sm-row">
            <div class="unit-left">
              <div class="post-creative-left">
                ...
                <p class="post-creative-text"><?php the_content()?></p>
                <p class="post-creative-text"><a href="<?php the_permalink();?>">Continue reading</a></p>
              </div>
            </div>
            <div class="unit-body">
